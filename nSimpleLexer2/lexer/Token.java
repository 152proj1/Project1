...
public class Token {
    ...
    public static String checkBaseType(String s) {
        try {
            ...
            System.out.println("    ** Not a valid BASE_TYPE **");
        }
        return "fail";
    }
    ...
    nullToken = new Token(-1, "empty", "empty"), EOF = new Token(-2, "EOF", "EOF"),

            base_int = new Token(-3, "BASE_TYPE", "int"), base_float = new Token(-4, "BASE_TYPE", "float"),
            base_bool = new Token(-5, "BASE_TYPE", "bool"),

            AND = new Token(1, "AND", "&&"), BREAK = new Token(3, "BREAK", "break"), DO = new Token(4, "DO", "do"),
            ELSE = new Token(5, "ELSE", "else"), EQ = new Token(6, "EQ", "=="), FALSE = new Token(7, "FALSE", "false"),
            FOR = new Token(8, "FOR", "for"), GE = new Token(9, "GE", ">="), IF = new Token(11, "IF", "if"),
            LE = new Token(12, "LE", "<="), NE = new Token(13, "NE", "!="), OR = new Token(15, "OR", "||"),
            TRUE = new Token(17, "TRUE", "true"), WHILE = new Token(18, "WHILE", "while"),
            semic_ = new Token(19, ";", ";"), eq_ = new Token(20, "=", "="), greaterTh_ = new Token(21, ">", ">"),
            lessTh_ = new Token(22, "<", "<"), openPar_ = new Token(23, "(", "("), closePar_ = new Token(24, ")", ")"),
            openBr_ = new Token(25, "{", "{"), closeBr_ = new Token(26, "}", "}"), plus_ = new Token(27, "+", "+"),
            minus_ = new Token(28, "-", "-"), mult_ = new Token(29, "*", "*"), slash_ = new Token(30, "/", "/");
